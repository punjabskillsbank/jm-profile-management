...
public class ClientAuditAspect {
    ...
    public Object auditClientUpdate(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            log.info("ClientAuditAspect triggered for: {}", pjp.getSignature());
            ...
            Map<String, Object> auditPayload = Map.of(
                    "serviceName", "client",           // service key used by audit-logging to pick handler
                    "userId", userId,
